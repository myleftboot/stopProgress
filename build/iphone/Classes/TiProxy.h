...
//Rare exceptions to indicate a bug in the _stopprogress code (Eg, function that a subclass should have implemented)
...
/**
 The base class for stopProgress proxies.
 */
