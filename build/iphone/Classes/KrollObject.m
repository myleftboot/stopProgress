 ...
 * Copyright (c) 2009-2011 by stopProgress, Inc. All Rights Reserved.
...
//@interface stopProgressObject : NSObject
//@end

@interface stopProgressObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[stopProgressObject class]])
		{
			for (NSString *key in [[(stopProgressObject*)o modules] allKeys])
			{
