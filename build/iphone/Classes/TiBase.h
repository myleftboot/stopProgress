...
// in simulator we redefine to format for stopProgress Developer console
...
{\
	NSString * exceptionName = [@"org.stopprogress." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.stopprogress";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIstopProgressNativeItemNone = -1, 
	UIstopProgressNativeItemSpinner = -2,
	UIstopProgressNativeItemProgressBar = -3,
	
	UIstopProgressNativeItemSlider = -4,
	UIstopProgressNativeItemSwitch = -5,
	UIstopProgressNativeItemMultiButton = -6,
	UIstopProgressNativeItemSegmented = -7,
	
	UIstopProgressNativeItemTextView = -8,
	UIstopProgressNativeItemTextField = -9,
	UIstopProgressNativeItemSearchBar = -10,
	
	UIstopProgressNativeItemPicker = -11,
	UIstopProgressNativeItemDatePicker = -12,
	
	UIstopProgressNativeItemInfoLight = -13,
	UIstopProgressNativeItemInfoDark = -14,
	
	UIstopProgressNativeItemDisclosure = -15,
	
	UIstopProgressNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all stopProgress instances of
