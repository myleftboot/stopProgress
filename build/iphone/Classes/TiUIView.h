...
/**
 Base class for all stopProgress views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the stopProgress view hierarchy (such as wrapped iOS UIViews) was touched.
