...
@interface stopProgressObject : KrollCoverageObject {
#else
@interface stopProgressObject : KrollObject {
#endif
@private
...
extern NSString * stopProgress$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	stopProgressObject *_stopprogress;
    KrollObject* console;
	BOOL shutdown;
